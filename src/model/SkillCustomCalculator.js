...
const SkillCustomCalculatorModel = {
  ...
  skillNotListToBasic: {
    ...
    '莱欧斯-威吓战法': new Set(['atk_scale']),
    '战车-倾泻弹药': new Set(['atk_scale']),
    '截云-掷旧尘': new Set(['atk_scale']),
    '吉星-欢迎您来！': new Set(['atk']),
