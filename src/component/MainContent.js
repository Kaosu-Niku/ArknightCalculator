    ...
    const loadData = async (type) => {
      ...
      $(attackSkillTableRef.current).DataTable({
        ...
        columns: [
          ...
          { title: "彈藥數量", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'attack@trigger_time'); } },  
          ...
          { title: "攻擊乘算", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'atk'); } },
          { title: "攻擊倍率", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'atk_scale'); } },
          { title: "攻擊間隔調整", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'base_attack_time'); } },           
          { title: "攻擊速度加算", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'attack_speed'); } },
          { title: "攻擊次數", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'times'); } },
          { title: "無視敵方防禦", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'def_penetrate_fixed'); } },
          { title: "削減敵方防禦", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'def') < 0 ? SkillCalculatorModel.skillCustomAttribute(whichType, row, 'def') : 0; } },
          { title: "削減敵方法抗", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'magic_resistance') < 0 ? SkillCalculatorModel.skillCustomAttribute(whichType, row, 'magic_resistance') : 0; } },
          { title: "天賦效果提升", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'talent_scale'); } },
          { title: "傷害倍率", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'damage_scale'); } },
      ...
      $(defSkillTableRef.current).DataTable({
        ...
        columns: [
          ...
          { title: "彈藥數量", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'attack@trigger_time'); } },
          { title: "技能類型", data: null, render: function (data, type, row) { return BasicCalculatorModel.memberSubProfessionId(SkillCalculatorModel.skillFromMember(row, processedCharacterData), subProfessionIdJsonData).attackType; } },   
          { title: "生命提升", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'max_hp'); } },
          { title: "防禦提升", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'def') > 0 ? SkillCalculatorModel.skillCustomAttribute(whichType, row, 'def') : 0; } },
          { title: "我方法抗提升", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'magic_resistance') > 0 ? SkillCalculatorModel.skillCustomAttribute(whichType, row, 'magic_resistance') : 0; } },
          //{ title: "閃避提升", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillAttribute(whichType, row, 'prob'); } }, 
          { title: "生命回復", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'heal_scale'); } },
          { title: "每秒固定回血", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'hp_recovery_per_sec'); } }, 
          { title: "每秒百分比回血", data: null, render: function (data, type, row) { return SkillCalculatorModel.skillCustomAttribute(whichType, row, 'hp_recovery_per_sec_by_max_hp_ratio'); } },
